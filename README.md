...
```
_Lưu ý: admin là tên user_admin_
...
**Còn nếu muốn cài 2 máy khác nhau 1 máy namenode 1 máy datanode**
với 2 IP riêng
- NameNode: `192.168.1.100`
- DataNode: `192.168.1.101`

```
#file hdfs-site.xml máy DataNode
<configuration>
  <property>
    <name>dfs.datanode.data.dir</name>
    <value>/home/admin/hadoop-3.4.0/data/datanode</value>
...
# file hdfs-site.xml tại máy NameNode
<configuration>
  <property>
    <name>dfs.replication</name>
    <value>1</value>
  ...
  <property>
    <name>dfs.namenode.name.dir</name>
    <value>/home/admin/hadoop-3.4.0/data/namenode</value>
  </property>
  <property>
    <name>dfs.namenode.rpc-address</name>
